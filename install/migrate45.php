...
if ($lng == "en") {
  ...
  $clean2 = "<CENTER>This script is ment:</CENTER><UL><LI>for migrating to GuppY version ".$version." from a version 4.0</UL>";
  ...
  $clean2 = "<CENTER>Ce script permet :</CENTER><UL><LI>de migrer à la version ".$version." de GuppY à partir d'une version 4.0</UL>";
...
\$serviz[27] = stripslashes(\"$serviz[27]\"); // libre...
...
function CreateErrorDirectory() {
  @mkdir (DATAREP."error", 0755);
  copy("backindex.php",DATAREP."error/"."index.php");
}
