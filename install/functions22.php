<?php
/*
    Functions - miniPortail PHP Script version 2.2
...
if (stristr($_SERVER["SCRIPT_NAME"], "functions22.php")) {
...
function DrawSmileys($num) {
  ...
  echo "</tr><tr>\n";
  for ($i = 0; $i < count($souriez); $i++) {
    echo "<td align=\"center\"><a href=\"JavaScript:AddSmiley".$num."('".$souriez[$i][0]."')\"><img src=\"".CHEMIN.$souriez[$i][1]."\" border=\"0\" alt=\"".$souriez[$i][0]."\"></a></td>\n";
  }
  echo "</tr>\n";
  echo "<tr><td>&nbsp;</td></tr>\n";
  echo "</table>\n";
